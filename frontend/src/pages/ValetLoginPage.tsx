...
import { Car, Mail, Loader2, ArrowLeft, CheckCircle2, AlertCircle } from 'lucide-react';
...
export default function ValetLoginPage() {
 ...
 email: email.trim(),
 options: {
 emailRedirectTo: `${window.location.origin}/vales/dashboard` } });
 ...
 <div>
 <h1 className="text-2xl font-extrabold">Vale Giriş</h1>
 ...
 <Link to="/vale-basvuru" className="text-brand-600 hover:underline font-semibold">Vale Başvurusu Yap</Link>
 </div>
 </form>
 )}
 </div>
