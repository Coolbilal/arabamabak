...
import { ArrowLeft, Wallet, Loader2, CheckCircle2, Clock, Download, Car, Calendar } from 'lucide-react';
import { formatDateTime } from '../lib/utils';

export default function ValetEarningsPage() {
  const { user } = useAuth();
